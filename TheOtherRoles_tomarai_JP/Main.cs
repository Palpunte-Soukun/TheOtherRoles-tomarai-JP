...
{
    [BepInPlugin(Id, "The Other Roles tomarai-JP", VersionString)]
    ...
    public class TheOtherRoles_tomarai_JPPlugin : BasePlugin
    {
        ...
        public static TheOtherRoles_tomarai_JPPlugin Instance;
        ...
        public static Sprite GetModStamp() {
            ...
            return ModStamp = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.ModStamp.png", 150f);
        }
    }
    ...
    public static class DebugManager
    {
        ...
        {
            if (!TheOtherRoles_tomarai_JPPlugin.DebugMode.Value) return;
