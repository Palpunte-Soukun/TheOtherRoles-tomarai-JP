...
$@"<size=130%><color=#ff351f>TheOtherRoles_tomarai_JP</color></size> v{TheOtherRoles_tomarai_JPPlugin.Version.ToString()}
...
GitHub寄稿者: Gendelo, Alex2911, amsyarasyiq, MaximeGillot, Psynomit</size>";
        ...
        private static class PingTrackerPatch
        {
            ...
            static void Prefix(PingTracker __instance) {
                if (modStamp == null) {
                    ...
                    rend.sprite = TheOtherRoles_tomarai_JPPlugin.GetModStamp();
            ...
            static void Postfix(PingTracker __instance){
                ...
                if (AmongUsClient.Instance.GameState == InnerNet.InnerNetClient.GameStates.Started) {
                    __instance.text.text = $"<size=130%><color=#ff351f>TheOtherRoles tomarai JP</color></size> v{TheOtherRoles_tomarai_JPPlugin.Version.ToString()}\n" + __instance.text.text;
        ...
        public static class LogoPatch
        {
            ...
            static void Postfix(PingTracker __instance) {
                ...
                loadSprites();
                renderer.sprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.Banner.png", 300f);
            ...
            public static void loadSprites() {
                if (bannerSprite == null) bannerSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.Banner.png", 300f);
                if (horseBannerSprite == null) horseBannerSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.bannerTheHorseRoles.png", 300f);
            }
