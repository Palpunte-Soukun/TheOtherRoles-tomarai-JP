...
namespace TheOtherRoles_tomarai_JP.Patches 
{
    ...
    public static class ClientOptionsPatch
    {
        private static SelectionBehaviour[] AllOptions = {
            new SelectionBehaviour("ストリーマーモード", () => TheOtherRoles_tomarai_JPPlugin.StreamerMode.Value = !TheOtherRoles_tomarai_JPPlugin.StreamerMode.Value, TheOtherRoles_tomarai_JPPlugin.StreamerMode.Value),
            new SelectionBehaviour("霊界からタスク数が見れる", () => MapOptions.ghostsSeeTasks = TheOtherRoles_tomarai_JPPlugin.GhostsSeeTasks.Value = !TheOtherRoles_tomarai_JPPlugin.GhostsSeeTasks.Value, TheOtherRoles_tomarai_JPPlugin.GhostsSeeTasks.Value),
            new SelectionBehaviour("霊界から投票先が見れる", () => MapOptions.ghostsSeeVotes = TheOtherRoles_tomarai_JPPlugin.GhostsSeeVotes.Value = !TheOtherRoles_tomarai_JPPlugin.GhostsSeeVotes.Value, TheOtherRoles_tomarai_JPPlugin.GhostsSeeVotes.Value),
            new SelectionBehaviour("霊界から役職が見れる", () => MapOptions.ghostsSeeRoles = TheOtherRoles_tomarai_JPPlugin.GhostsSeeRoles.Value = !TheOtherRoles_tomarai_JPPlugin.GhostsSeeRoles.Value, TheOtherRoles_tomarai_JPPlugin.GhostsSeeRoles.Value),
            new SelectionBehaviour("霊界からさらなる属性が見れる", () => MapOptions.ghostsSeeModifier = TheOtherRoles_tomarai_JPPlugin.GhostsSeeModifier.Value = !TheOtherRoles_tomarai_JPPlugin.GhostsSeeModifier.Value, TheOtherRoles_tomarai_JPPlugin.GhostsSeeModifier.Value),
            new SelectionBehaviour("最終結果を表示する", () => MapOptions.showRoleSummary = TheOtherRoles_tomarai_JPPlugin.ShowRoleSummary.Value = !TheOtherRoles_tomarai_JPPlugin.ShowRoleSummary.Value, TheOtherRoles_tomarai_JPPlugin.ShowRoleSummary.Value),
            new SelectionBehaviour("明るい / 暗い を表示する", () => MapOptions.showLighterDarker = TheOtherRoles_tomarai_JPPlugin.ShowLighterDarker.Value = !TheOtherRoles_tomarai_JPPlugin.ShowLighterDarker.Value, TheOtherRoles_tomarai_JPPlugin.ShowLighterDarker.Value),
        };
	...
	public static class HiddenTextPatch
	{
		...
		{
			bool flag = TheOtherRoles_tomarai_JPPlugin.StreamerMode.Value && (__instance.name == "GameIdText" || __instance.name == "IpTextBox" || __instance.name == "PortTextBox");
