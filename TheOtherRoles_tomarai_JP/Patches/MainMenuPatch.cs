...
using TheOtherRoles_tomarai_JP.Patches;

namespace TheOtherRoles_tomarai_JP.Modules {
    ...
    public class MainMenuPatch {
        ...
        private static void Prefix(MainMenuManager __instance) {
            ...
            // Horse mode stuff
            var horseModeSelectionBehavior = new ClientOptionsPatch.SelectionBehaviour("Enable Horse Mode", () => MapOptions.enableHorseMode = TheOtherRoles_tomarai_JPPlugin.EnableHorseMode.Value = !TheOtherRoles_tomarai_JPPlugin.EnableHorseMode.Value, TheOtherRoles_tomarai_JPPlugin.EnableHorseMode.Value);
            ...
            horseModeOffSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.HorseModeButtonOff.png", 75f);
            horseModeOnSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.HorseModeButtonOn.png", 75f);
            ...
            passiveHorseButton.OnClick.AddListener((System.Action)delegate {
                ...
                if (horseButtonState) {
                    if (horseModeOnSprite == null) horseModeOnSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.HorseModeButtonOn.png", 75f);
                    spriteHorseButton.sprite = horseModeOnSprite;
                }
                else {
                    if (horseModeOffSprite == null) horseModeOffSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.HorseModeButtonOff.png", 75f);
    ...
    public static class Announcement
    {
        ...
        public static bool Prefix(AnnouncementPopUp __instance)
        {
            ...
            text.text = $"<size=150%><color=#FC0303>The Other Roles tomarai-JP </color> {(updateData.Tag)}\n{(updateData.Content)}";
