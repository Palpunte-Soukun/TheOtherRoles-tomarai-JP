...
namespace TheOtherRoles_tomarai_JP.Objects {
    ...
    public class Portal {
        ...
        public static Sprite getFgAnimationSprite(int index) {
            ...
            if (portalFgAnimationSprites[index] == null)
                portalFgAnimationSprites[index] = (Helpers.loadSpriteFromResources($"TheOtherRoles_tomarai_JP.Resources.PortalAnimation.portal_{(index):000}.png", 115f));
        ...
        public static void startTeleport(byte playerId) {
            ...
            string playerNameDisplay = Portalmaker.logOnlyHasColors ? "プレイヤー (" + (Helpers.isLighterColor(playerControl.Data.DefaultOutfit.ColorId) ? "明るい" : "暗い") + ")" : playerControl.Data.PlayerName;

            int colorId = playerControl.Data.DefaultOutfit.ColorId;

            if (Camouflager.camouflageTimer > 0) {
                playerNameDisplay = "カモフラージュされたプレイヤー";
                colorId = 6;
            }
        ...
        public Portal(Vector2 p) {
            ...
            bool playerIsPortalmaker = PlayerControl.LocalPlayer == TheOtherRoles_tomarai_JP.Portalmaker.portalmaker;
        ...
        private static void preloadSprites() {
            ...
            portalSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.PortalAnimation.plattform.png", 115f);
        }
