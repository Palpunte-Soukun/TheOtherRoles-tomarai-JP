...
namespace TheOtherRoles_tomarai_JP.Objects {
    class Garlic {
        ...
        public static Sprite getGarlicSprite() {
            ...
            garlicSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.Garlic.png", 300f);
            return garlicSprite;
        }
        ...
        public static Sprite getBackgroundSprite() {
            ...
            backgroundSprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.GarlicBackground.png", 60f);
