...
namespace TheOtherRoles_tomarai_JP.Objects {
    class Bloodytrail {
        ...
        public static List<Sprite> getBloodySprites() {
            ...
            sprites.Add(Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.Blood1.png", 700));
            sprites.Add(Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.Blood2.png", 500));
            sprites.Add(Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.Blood3.png", 300));
            return sprites;
        }
