...
using TheOtherRoles_tomarai_JP.Modules;
using HarmonyLib;
using Hazel;
...
namespace TheOtherRoles_tomarai_JP {
    ...
    public static class Helpers {
        ...
        public static void shareGameVersion() {
            ...
            writer.Write((byte)TheOtherRoles_tomarai_JPPlugin.Version.Major);
            writer.Write((byte)TheOtherRoles_tomarai_JPPlugin.Version.Minor);
            writer.Write((byte)TheOtherRoles_tomarai_JPPlugin.Version.Build);
            writer.WritePacked(AmongUsClient.Instance.ClientId);
            writer.Write((byte)(TheOtherRoles_tomarai_JPPlugin.Version.Revision < 0 ? 0xFF : TheOtherRoles_tomarai_JPPlugin.Version.Revision));
            writer.Write(Assembly.GetExecutingAssembly().ManifestModule.ModuleVersionId.ToByteArray());
            AmongUsClient.Instance.FinishRpcImmediately(writer);
            RPCProcedure.versionHandshake(TheOtherRoles_tomarai_JPPlugin.Version.Major, TheOtherRoles_tomarai_JPPlugin.Version.Minor, TheOtherRoles_tomarai_JPPlugin.Version.Build, TheOtherRoles_tomarai_JPPlugin.Version.Revision, Assembly.GetExecutingAssembly().ManifestModule.ModuleVersionId, AmongUsClient.Instance.ClientId);
        }
