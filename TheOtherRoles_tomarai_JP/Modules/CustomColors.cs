...
namespace TheOtherRoles_tomarai_JP.Modules {
    public class CustomColors {
        ...
        public static void Load() {
            ...
            /* Custom Colors */
            colors.Add(new CustomColor { longname = "サーモン",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "ボルドー",
            ...
            colors.Add(new CustomColor { longname = "ピーチ",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "ワサビ",
            ...
            colors.Add(new CustomColor { longname = "ホットピンク",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "ペトロール", 
            ...
            colors.Add(new CustomColor { longname = "レモン",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "シグナルオレンジ",
