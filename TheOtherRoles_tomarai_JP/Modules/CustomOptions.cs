...
namespace TheOtherRoles_tomarai_JP {
    public class CustomOption {
        ...
        public CustomOption(int id, CustomOptionType type, string name,  System.Object[] selections, System.Object defaultValue, CustomOption parent, bool isHeader) {
            ...
            selection = 0;
            if (id != 0) {
                entry = TheOtherRoles_tomarai_JPPlugin.Instance.Config.Bind($"Preset{preset}", id.ToString(), defaultSelection);
        ...
        // Static behaviour
            ...
            foreach (CustomOption option in CustomOption.options) {
                ...
                option.entry = TheOtherRoles_tomarai_JPPlugin.Instance.Config.Bind($"Preset{preset}", option.id.ToString(), option.defaultSelection);
    ...
    class GameOptionsMenuStartPatch {
        public static void Postfix(GameOptionsMenu __instance) {
            if (GameObject.Find("TORSettings") != null) { // Settings setup has already been performed, fixing the title of the tab and returning
                GameObject.Find("TORSettings").transform.FindChild("GameGroup").FindChild("Text").GetComponent<TMPro.TextMeshPro>().SetText("The Other Roles tomarai-JP Settings");
                return;
            }
            ...
            torTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.TabIcon.png", 100f);
            ...
            impostorTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.TabIconImpostor.png", 100f);
            ...
            neutralTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.TabIconNeutral.png", 100f);
            ...
            crewmateTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.TabIconCrewmate.png", 100f);
            ...
            modifierTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.loadSpriteFromResources("TheOtherRoles_tomarai_JP.Resources.TabIconModifier.png", 100f);
    ...
    class GameOptionsDataPatch
    {
            ...
            foreach (CustomOption option in options) {
                if (option.parent != null) {
                    ...
                    if (option == CustomOptionHolder.crewmateRolesCountMin) {
                        var optionName = CustomOptionHolder.cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "クルー役職");
                        ...
                        var optionName = CustomOptionHolder.cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "第三陣営役職");
                        ...
                        var optionName = CustomOptionHolder.cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "インポスター役職");
                        ...
                        var optionName = CustomOptionHolder.cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "属性");
        ...
        {
            int counter = TheOtherRoles_tomarai_JPPlugin.optionsPage;
            string hudString = counter != 0 ? Helpers.cs(DateTime.Now.Second % 2 == 0 ? Color.white : Color.red, "(必要であれば、マウスホイールをスクロールしてください)\n\n") : "";

            switch (counter) {
                case 0:
                    hudString += "ページ 1: バニラの設定 \n\n" + __result;
                    break;
                case 1:
                    hudString += "ページ 2: The Other Roles tomarai-JPの設定 \n" + buildOptionsOfType(CustomOption.CustomOptionType.General, false);
                    break;
                case 2:
                    hudString += "ページ 3: 役職と属性のレート \n" + buildRoleOptions();
                    break;
                case 3:
                    hudString += "ページ 4: インポスター役職設定 \n" + buildOptionsOfType(CustomOption.CustomOptionType.Impostor, false);
                    break;
                case 4:
                    hudString += "ページ 5: 第三陣営役職設定 \n" + buildOptionsOfType(CustomOption.CustomOptionType.Neutral, false);
                    break;
                case 5:
                    hudString += "ページ 6: クルー役職設定 \n" + buildOptionsOfType(CustomOption.CustomOptionType.Crewmate, false);
                    break;
                case 6:
                    hudString += "ページ 7: 属性設定 \n" + buildOptionsOfType(CustomOption.CustomOptionType.Modifier, false);
                    break;
            }

            hudString += $"\n Tabキーを押すか、数字キーを押してページを変更することができます... ({counter+1}/7)";
            __result = hudString;
        }
    }
    ...
    public static class GameOptionsNextPagePatch
    {
        ...
        {
            int page = TheOtherRoles_tomarai_JPPlugin.optionsPage;
            if (Input.GetKeyDown(KeyCode.Tab)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = (TheOtherRoles_tomarai_JPPlugin.optionsPage + 1) % 7;
            }
            if (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 0;
            }
            if (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 1;
            }
            if (Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 2;
            }
            if (Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Keypad4)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 3;
            }
            if (Input.GetKeyDown(KeyCode.Alpha5) || Input.GetKeyDown(KeyCode.Keypad5)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 4;
            }
            if (Input.GetKeyDown(KeyCode.Alpha6) || Input.GetKeyDown(KeyCode.Keypad6)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 5;
            }
            if (Input.GetKeyDown(KeyCode.Alpha7) || Input.GetKeyDown(KeyCode.Keypad7)) {
                TheOtherRoles_tomarai_JPPlugin.optionsPage = 6;
            }
            if (page != TheOtherRoles_tomarai_JPPlugin.optionsPage) {
